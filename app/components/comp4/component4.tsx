...
export default function Lastcomp() {
	return (
		<main className="flex flex-col items-center md:text-start text-center px-5">
			...
			<Link className="text-blue-600 mt-4 " href="/">
				{" "}
			...
			<div className="max-w-[1000px] w-full mt-10 grid md:grid-cols-2 gap-5 ">
				<div className="bg-gray-100 rounded-2xl py-5">
					...
					<div className="flex items-start gap-5 mt-8 ml-6">
						<Link
							className="border-gray-200 border-2 px-4 py-2 bg-white rounded-xl "
							href="/"
						>
							{" "}
							this is a niga
				...
				<div className="bg-gray-100 rounded-xl gap-5 py-5">
					...
					<div className="flex items-start gap-5 ml-6">
						<Link
							className="transition-color hover:bg-indigo-500 hover:text-white duration-600 border-gray-200 border-2 px-4 py-2 bg-white rounded-xl "
							href="/"
						>
							{" "}
							this is a niga
						...
						<Link
							className="transition-all hover:scale-115 hover:bg-indigo-500 hover:text-white duration-600  border-gray-200 border-2 px-4 py-2 bg-white rounded-xl"
							href="/"
						>
							{" "}
							where is my niga
