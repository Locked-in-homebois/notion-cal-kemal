            ...
            <div className="max-w-[1000px] w-full mt-10 grid md:grid-cols-2 gap-5 ">
                ...
                <div className="bg-gray-100 rounded-xl gap-5 py-5">
                    ...
                    <div className="flex items-start gap-5 ml-6">
                        ...
                        <Link className="transition-all hover:scale-1 hover:bg-black hover:text-white duration-600  border-gray-200 border-2 px-4 py-2 bg-white rounded-xl" href="/"> where is my niga</Link>
                    </div>
                </div>
            </div>
        </main >
