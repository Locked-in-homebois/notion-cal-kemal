import Looperpropertiepart from "./faqlist"

const itemlisty = [{

    quesions: "Which calendar provider(s) is Notion Calendar compatible with? "
    , answeres: "Currently, Notion Calendar integrates and syncs with Google Calendar accounts and Apple iCloud-synced Calendars. Adding support for other calendar providers such as Outlook is on our roadmap."
    , coloredolores: "red"
...
export default function RealFakin() {
    ...
    return (
        ...
        <div className="flex  flex-col items-center max-w-[1000px]  mt-20 ">
            <h1 className=" text-5xl">Questions & Answers</h1>

            {itemlisty.map((dalgalar, index) => (
                <Looperpropertiepart
                    key={index}
                    quesions={dalgalar.quesions}
                    answeres={dalgalar.answeres}
                    coloredolores={dalgalar.coloredolores}
                />
