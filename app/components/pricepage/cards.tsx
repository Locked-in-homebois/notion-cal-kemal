                ...
                {CARDSELEMENTS_DATA.map((item, index) => (
                    ...
                    <div className={` ${gridprops} `} key={index}>
                        ...
                        <div className="max-w-[300px] rounded-lg bg-gray-200">
                            ...
                            <div className="px-4 py-2 flex gap-4 font-bold"> <Brain /> <h1 >Notion AI</h1>  </div>
                            {INSIDEBOXSRING_DATA.map}
                            <p className="flex gap-2 px-4 py-2"> <Check size={20} className={` text-green-600`} />
