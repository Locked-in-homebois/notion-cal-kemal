...
export default function secondcomp() {
	return (
		<main className="flex flex-col justify-center items-center px-5 ">
			<h1 className="font-bold text-[45px] flex text-center justify-center mt-10 max-w-[480px] tracking-tighter">
				...
				<div className=" max-w-[1000px] w-full grid md:grid-cols-2 gap-5 ">
					<div className="bg-gray-100 rounded-xl flex flex-col  ">
						<div className="px-10 py-5">
							...
							<p className="">
								With info from Notion right in your calendar,
								you’ll always have full context for every
								meeting.
							</p>
						</div>
						<Image
