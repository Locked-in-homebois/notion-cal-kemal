...
export default function secondcomp() {
  return (
    <main className="flex flex-col justify-center items-center ">
      <h1 className="font-bold text-[45px] flex text-center justify-center max-w-[480px] tracking-tighter">
        Fully integrated with your Notion workspace.
      </h1>
      <div className=" bg-gray-100  mt-15 w-full md:max-w-[1000px] h-auto rounded-[12]">
