...
export default function thirdcomp() {
  return (
    <main className="flex flex-col items-center w-full">
      <h1 className="font-bold text-[45px] flex justify-center w-full max-w-[600px] text-center tracking-tighter">
        Work and life, playing nice.
      </h1>
      <div className=" bg-gray-100 mt-16 justify-center md:w-[1000px] w-full h-auto rounded-xl">
        <div className="px-10 py-5 ">
          ...
          <p className=" text-[20px] text-black  max-w-[600] ">
